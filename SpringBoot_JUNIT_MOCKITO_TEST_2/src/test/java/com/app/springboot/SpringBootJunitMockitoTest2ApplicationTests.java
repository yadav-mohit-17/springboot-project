...
public class SpringBootJunitMockitoTest2ApplicationTests {
	...
	@Test
	@Order(2)
	@DisplayName("STUDENT # GETTING ALL RECORD")
	public void testGetAllStudent() throws Exception {
		//Create Mock Request
		MockHttpServletRequestBuilder request=MockMvcRequestBuilders.get("/v1/api/student/findAll");
		
		//Execute and read result
		MvcResult result=mockMvc.perform(request).andReturn();
		
		//Read Response from Result
		MockHttpServletResponse response=result.getResponse();
	...
	public void testUpdateStudent() throws Exception {
		//Create Mock Request
		MockHttpServletRequestBuilder request=MockMvcRequestBuilders.put("/v1/api/student/update")
					.contentType(MediaType.APPLICATION_JSON)
	...
	@Test
	@Order(5)
	@DisplayName("STUDENT # DELETE STUDENT")
	public void testDelteStudent() throws Exception {
		//Create Mock Request
		MockHttpServletRequestBuilder request=MockMvcRequestBuilders.delete("/v1/api/student/delete/{id}",1);
